...
![buy1](/public/assets/2_how_to_use/register/buy1.png)

输入**邮箱**，选择**支付方式**，点击**下单**并**付款**。

⚠️付款前注意看商品描述，避免错误购买，下单后不退不换❗️

![buy2](/public/assets/2_how_to_use/register/buy2.png)

付款后会显示如下信息，点击**复制**。

顶部**订单查询**通过订单号、邮箱、浏览器3种方式也可查询到如下信息。

![buy3](/public/assets/2_how_to_use/register/buy3.png)
...
![renewal1](/public/assets/2_how_to_use/register/renewal1.png)

按照提示，输入发电地址复制的**续期码**，即可完成续期🤩

<div align="center">
<img src="/public/assets/2_how_to_use/register/renewal2.png" alt="renewal2" width="50%" height="50%" />
</div>
...
![register1](/public/assets/2_how_to_use/register/register1.png)

根据提示信息，输入**注册码**，点击**发送**。

![register2](/public/assets/2_how_to_use/register/register2.png)

点击**注册**，根据提示，输入**用户名**和**安全码**，点击**发送**。

![register3](/public/assets/2_how_to_use/register/register3.png)

注册成功😎提供的信息需要记住，供后续使用👉🏻[**多端使用**](user_guide.md)，若忘记线路👉🏻[**线路获取**](#线路获取)
...
![register4](/public/assets/2_how_to_use/register/register4.png)
...
![route1](/public/assets/2_how_to_use/register/route1.png)

选择合适的线路，将**线路及端口**信息记录下来，供后续使用。下一步👉🏻[**多端使用**](user_guide.md)
