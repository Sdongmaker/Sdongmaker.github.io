...
![buy1](../images/2_how_to_use/register/buy1.png)

输入**邮箱**，选择**支付方式**，点击**下单**并**付款**。

⚠️付款前注意看商品描述，避免错误购买，下单后不退不换❗️

![buy2](../images/2_how_to_use/register/buy2.png)

付款后会显示如下信息，点击**复制**。

顶部**订单查询**通过订单号、邮箱、浏览器3种方式也可查询到如下信息。

![buy3](../images/2_how_to_use/register/buy3.png)
...
![renewal1](../images/2_how_to_use/register/renewal1.png)

按照提示，输入发电地址复制的**续期码**，即可完成续期🤩

<div align="center">
<img src="../images/2_how_to_use/register/renewal2.png" alt="renewal2" width="50%" height="50%" />
</div>
...
![register1](../images/2_how_to_use/register/register1.png)

根据提示信息，输入**注册码**，点击**发送**。

![register2](../images/2_how_to_use/register/register2.png)

点击**注册**，根据提示，输入**用户名**和**安全码**，点击**发送**。

![register3](../images/2_how_to_use/register/register3.png)
...
![register4](../images/2_how_to_use/register/register4.png)
...
![route1](../images/2_how_to_use/register/route1.png)
